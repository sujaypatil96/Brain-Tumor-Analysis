...
<?php
    ...
    // create a collection
    $collection = $db->test->normalized_exps;
    ...
    for ($i = 0; $i < 15041; $i++) {
        ...
        // $split_arr[2];
        $document = array(
            'gene_name' => $split_arr[0][0],
            'cell_type' => 'Peri Tumor Astrocytes',
            'sample_type' => '69 yo surround | 59 yo | 65 yo | 64 yo',
            'expression_level' => $split_arr[0][2]
        );

        $collection->insert($document);
        echo "inserted document " . $i . "<br>";
    }
